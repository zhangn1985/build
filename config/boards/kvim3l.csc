...
uboot_vim3l_postprocess()
{
	...
	$1/$2/aml_encrypt_g12a --bl30sig --input $1/$2/bl30_new.bin \
					--output $1/$2/bl30_new.bin.g12a.enc \
					--level v3
	$1/$2/aml_encrypt_g12a --bl3sig --input $1/$2/bl30_new.bin.g12a.enc \
					--output $1/$2/bl30_new.bin.enc \
					--level v3 --type bl30
	$1/$2/aml_encrypt_g12a --bl3sig --input $1/$2/bl31.img \
					--output $1/$2/bl31.img.enc \
					--level v3 --type bl31
	$1/$2/aml_encrypt_g12a --bl3sig --input bl33.bin --compress lz4 \
					--output $1/$2/bl33.bin.enc \
					--level v3 --type bl33 --compress lz4
	$1/$2/aml_encrypt_g12a --bl2sig --input $1/$2/bl2_new.bin \
					--output $1/$2/bl2.n.bin.sig
	$1/$2/aml_encrypt_g12a --bootmk \
					--output u-boot.bin \
...
{
	uboot_vim3l_postprocess $SRC/cache/sources/khadas-blobs/ vim3l
}
